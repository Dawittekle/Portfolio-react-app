          ...
          <div className="hfooter-links">
            <div className="hfooter-column1">
              ...
              <div className="hfooter-footer-links1">
                <a
                  href="/" 
                  className="hfooter-link1 thq-body-small"
                >
                  {props.link1 ?? (
                    <Fragment>
                ...
                <a
                  href="/projects"
                  className="hfooter-link3 thq-body-small"
                >
                  {props.link3 ?? (
                    <Fragment>
                ...
                <a
                  href="/blog "
                  className="hfooter-link4 thq-body-small"
                >
                  {props.link4 ?? (
                    <Fragment>
            ...
            <div className="hfooter-column2">
              ...
              <div className="hfooter-footer-links2">
                ...
                <div className="hfooter-row2 thq-flex-row">
                  <svg viewBox="0 0 1024 1024" className="thq-icon-small">
            ...
            <div className="hfooter-column3">
              ...
              <div className="hfooter-social-links">
                <div className="hfooter-link6">
                  ...
                  <a href="#" target="_blank"><span className="hfooter-social-link1 thq-body-small">
                    Facebook
                  </span></a>
                ...
                <div className="hfooter-link6">
                  ...
                  <a href="https://instagram.com/dawit.t" target="_blank"><span className="hfooter-social-link2 thq-body-small">
                    Instagram
                  </span></a>
                ...
                <div className="hfooter-link6">
                  ...
                  <a href="#" target="_blank"> <span className="hfooter-social-link3 thq-body-small">X</span></a>
                </div>
                <div className="hfooter-link6">
                  <svg
                    viewBox="0 0 877.7142857142857 1024"
                  ...
                  <a href="https://www.linkedin.com/in/dawit-teklebrhan-gebrewbet/" target="_blank"> <span className="hfooter-social-link4 thq-body-small">
                    LinkedIn
                  </span></a>
