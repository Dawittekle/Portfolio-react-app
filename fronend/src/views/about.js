  ...
  return (
    <div className="about-container">
      ...
      <Hnav
        text={
          <Fragment>
            <span className="about-text10">Dawit.</span>
          </Fragment>
        }
        link1={
          <Fragment>
            <span className="about-text11">_home</span>
          </Fragment>
        }
        link2={
          <Fragment>
            <span className="about-text12">_about</span>
          </Fragment>
        }
        link3={
          <Fragment>
            <span className="about-text13">_services</span>
          </Fragment>
        }
        link4={
          <Fragment>
            <span className="about-text14">_projects</span>
          </Fragment>
        }
        link5={
          <Fragment>
            <span className="about-text15">_blog</span>
          </Fragment>
        }
        action1={
          <Fragment>
            <span className="about-text16">Sign Up</span>
          </Fragment>
        }
        action2={
          <Fragment>
            <span className="about-text17">Log In</span>
          </Fragment>
        }
        rootClassName="hnavroot-class-name1"
        link51={
          <Fragment>
            <span className="about-text18">_contact</span>
          </Fragment>
        }
      ></Hnav>
      ...
      <Hfooter
        ...
        link1={
          <Fragment>
            <span className="about-text47">Home</span>
          </Fragment>
        }
        link2={
          <Fragment>
        ...
        phone={
          <Fragment>
            <span className="about-text52">+251902468877</span>
          </Fragment>
        }
        action1={
          <Fragment>
            <span className="about-text53">Subscribe</span>
          </Fragment>
        }
        content2={
          <Fragment>
        ...
        cookiesLink={
          <Fragment>
            <span className="about-text56">Contact me</span>
          </Fragment>
        }
        privacyLink={
          <Fragment>
        ...
        column1Title={
          <Fragment>
            <span className="about-text61">Pages</span>
          </Fragment>
        }
        column2Title={
          <Fragment>
            <span className="about-text62">Address</span>
          </Fragment>
        }
        rootClassName="hfooterroot-class-name1"
        socialLinkTitleCategory={
          <Fragment>
            <span className="about-text63">Follow Me</span>
          </Fragment>
        }
      ></Hfooter>
    </div>
